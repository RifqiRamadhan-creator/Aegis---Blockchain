...
\textit{Prodi Teknik Komputer, Departemen Teknik Elektro, Fakultas Teknik, Universitas Indonesia}\\
Mei 2026
}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.4\textwidth]{erd.png}
...
\bibitem{ethereum} V. Buterin, ``A Next-Generation Smart Contract and Decentralized Application Platform,'' 2013.
\bibitem{openzeppelin} OpenZeppelin, ``OpenZeppelin Contracts,'' \url{https://github.com/OpenZeppelin/openzeppelin-contracts}.
\bibitem{hardhat} Hardhat, ``Hardhat Documentation,'' \url{https://hardhat.org/docs}.
\bibitem{juicebox} Juicebox Protocol, ``Juicebox Documentation,'' \url{https://docs.juicebox.money/}.
\bibitem{hybridai} N/A, ``A Hybrid Blockchain--AI Architecture for Secure and Transparent Decentralized Crowdfunding,'' \textit{Journal of Artificial Intelligence and Technology}, Nov. 9, 2025. DOI: \url{https://doi.org/10.37965/jait.2025.0834}.
\end{thebibliography}
