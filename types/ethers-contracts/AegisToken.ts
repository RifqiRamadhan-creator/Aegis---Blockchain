...
export declare namespace Checkpoints {
  ...
  export interface AegisTokenInterface extends Interface {
...
decodeFunctionResult(functionFragment: 'transferOwnership', data: BytesLike): Result;
  ...
  export interface AegisToken extends BaseContract {
    
    connect(runner?: ContractRunner | null): AegisToken;
    waitForDeployment(): Promise<this>;

    interface: AegisTokenInterface;
